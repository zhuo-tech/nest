<template>
  <div>
    <basic-container>
      <avue-data-box :option="box"></avue-data-box>
    </basic-container>
    <basic-container>
      <avue-data-icons :option="icons"></avue-data-icons>
    </basic-container>
    <basic-container>
      <avue-data-progress :option="progress"></avue-data-progress>
    </basic-container>
    <basic-container>
      <avue-article :props="articleProps" :data="article"></avue-article>
    </basic-container>
  </div>
</template>
